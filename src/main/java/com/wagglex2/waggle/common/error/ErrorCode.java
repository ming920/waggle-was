...
public enum ErrorCode {
    ...
    CANNOT_UPDATE_ANOTHER_USER_ASSIGNMENT(HttpStatus.FORBIDDEN, "CANNOT_UPDATE_ANOTHER_USER_ASSIGNMENT", "다른 사용자의 과제 공고는 수정할 수 없습니다."),
    CANNOT_DELETE_ANOTHER_USER_ASSIGNMENT(HttpStatus.FORBIDDEN, "CANNOT_DELETE_ANOTHER_USER_ASSIGNMENT", "다른 사용자의 과제 공고는 삭제할 수 없습니다."),
    CANNOT_UPDATE_ANOTHER_USER_STUDY(HttpStatus.FORBIDDEN, "CANNOT_UPDATE_ANOTHER_USER_STUDY", "다른 사용자의 스터디 공고는 수정할 수 없습니다."),
    CANNOT_DELETE_ANOTHER_USER_STUDY(HttpStatus.FORBIDDEN, "CANNOT_DELETE_ANOTHER_USER_STUDY", "다른 사용자의 스터디 공고는 삭제할 수 없습니다."),
    ...
    // 409
    DUPLICATED_USER(HttpStatus.CONFLICT, "DUPLICATED_USER", "이미 가입된 사용자입니다."),
